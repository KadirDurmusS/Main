...
export function productFunc(products) {

    const productsContainer = document.getElementById("product-list");

    let results = "";
    products.forEach((item) => {
        results += ` <li class="products-item glide__slide">
        ...
        <div class="product-info">
            <a href="" class="product-tittle">${item.name}</a>
...
export function productFunc2(products) {
